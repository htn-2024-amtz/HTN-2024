...
<div className="flex-grow p-4 flex flex-col justify-center items-center gap-3 pt-[10vh]">
    <h1 className="text-4xl font-bold">AIagine</h1>
    <h2 className="tracking-normal text-gray-500 md:text-lg dark:text-gray-400">Experience the world through the eyes of
